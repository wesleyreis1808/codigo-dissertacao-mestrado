function ravg = func_WCFCPSC_First6Steps(Y,nSubBands,weights)
% CFCPSC algorithm
...
Fell = zeros(dim1Size,nSubBands); %(6,5)
for ell = 1:nSubBands %5 l
    for k = 1:Vcfcpsc %10 v

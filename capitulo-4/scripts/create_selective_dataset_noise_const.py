...
####################################################################################################
scenaries = [
    {  # scenary 1 - selectivity, uniform constant noise and no shadowing
        "runs": 15000,
        "PUsignal": 1,
        "s": 1,
        "m": 6,
    ...
    {  # scenary 2 - selectivity, uniform constant noise and shadowing
        "runs": 15000,
        "PUsignal": 1,
        "s": 1,
        "m": 6,
    ...
    {  # scenary 3 - selectivity, non-uniform constant noise and shadowing
        "runs": 15000,
        "PUsignal": 1,
        "s": 1,
        "m": 6,

...
result_directory = absolute_work_directory + "/result/evaluate_detectors_over_noise_const/"
...
if which_scenary == 1:
    scenary = "cenario1"
    X, Y = dataset.loadDataset(filename= dataset_directory + "selective_n(160)_m(6)_SNR(-10)_Sigma2avg(1)_rhoN(0.00)_PUsignal(1)_SPS(4)_shadowing(False)_p(4)_noise(uniform).mat")
elif which_scenary == 2:
    scenary = "cenario2"
    X, Y = dataset.loadDataset(filename= dataset_directory + "selective_n(160)_m(6)_SNR(-10)_Sigma2avg(1)_rhoN(0.00)_PUsignal(1)_SPS(4)_shadowing(True)_p(4)_noise(uniform).mat")
